...
% \includeonly{5_automatic_learning/automatic_learning}
\includeonly{6_evaluation/evaluation}
...
\include{4_expression_language/expression_language}

\include{5_automatic_learning/automatic_learning}

\include{6_evaluation/evaluation}
